...
public class DriveTrain extends SubsystemBase {
  ...
  public DriveTrain() {
    SparkMaxConfig leftFrontConfig = getLeaderConfig(true);
    SparkMaxConfig rightFrontConfig = getLeaderConfig(false);
  ...
  public void moveLeftMotors(double speed) {
    ...
    // Control speed - hopefully should be smoother
    // leftFrontMotor.getClosedLoopController().setReference(speed, ControlType.kMAXMotionPositionControl);
  }
